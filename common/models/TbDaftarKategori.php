...
class TbDaftarKategori extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_kategori'], 'exist', 'skipOnError' => true, 'targetClass' => IdKategori::className(), 'targetAttribute' => ['id_kategori' => 'id_kategori']],
        ];
    }
    ...
    {
        return $this->hasOne(IdKategori::className(), ['id_kategori' => 'id_kategori']);
    }
}
