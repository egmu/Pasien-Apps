 ...
 *
 * @property TbAntrianLocket[] $tbAntrianLockets
...
class TbPasien extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_pasien', 'alamat', 'pekerjaan'], 'string', 'max' => 25],
            [['nama_kk'], 'string', 'max' => 50],
            [['hub_keluarga', 'jenis_pasien', 'jenis_kelamin', 'pendidikan', 'agama', 'status_pernikahan', 'token'], 'string', 'max' => 20],
    ...
    /**
     * Gets query for [[TbAntrianLockets]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getTbAntrianLockets()
    {
        return $this->hasMany(TbAntrianLocket::className(), ['no_rm' => 'no_rm']);
    }
