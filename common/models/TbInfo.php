...
class TbInfo extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_kategori'], 'exist', 'skipOnError' => true, 'targetClass' => TbInfoKategori::className(), 'targetAttribute' => ['id_kategori' => 'id_kategori']],
        ];
    }
    ...
    {
        return $this->hasOne(TbInfoKategori::className(), ['id_kategori' => 'id_kategori']);
    }
}
